...
int main ()
{
  ...
  float                            ni         = 0.25f;                                               // Poisson's ratio [];
  float                            beta       = 1E+5f;                                               // Damping [kg*s*m].
  float                            R          = 1.0;                                                 // Particle's radius [#cells].
  ...
  {
    spacetime->process (boundary[i], N - 1, nu::MSH_PNT);                                            // Processing mesh...
  ...
  std::cout << std::endl;                                                                            // Printing message...
  std::cout << "Poisson's ratio:                            nu         = " << ni << " []";           // Printing message...
  std::cout << std::endl;                                                                            // Printing message...
  ...
  while(!gl->closed ())                                                                              // Opening window...
  {
    ...
    addParameter ("Mass density:      ", "[kg/m^2]", " = rho", &rho);
