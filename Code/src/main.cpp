...
int main ()
{
  ...
  size_t                           x_nodes        = 0;                                              // Number of nodes on x_side.
  size_t                           y_nodes        = 0;                                              // Number of nodes on y_side.
  size_t                           x_cells        = 0;                                              // Number of cells on x_side.
  size_t                           y_cells        = 0;                                              // Number of cells on y_side.
  ...
  int                              surface        = 2;                                              // "surface" tag.
  int                              perimeter      = 6;                                              // "perimeter" tag.
  int                              x_side         = 7;                                              // "x_side" tag.
  int                              y_side         = 8;                                              // "y_side" tag.
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////////
  // MESH "X" SIDE:
  spacetime->process (x_side, 1, NU_MSH_PNT);                                                       // Processing mesh...
  x_nodes         = spacetime->node.size ();                                                        // Getting number of nodes along "x" side...
  x_cells         = x_nodes - 1;                                                                    // Computing number of cells along "x" side...

  // MESH "Y" SIDE:
  spacetime->process (y_side, 1, NU_MSH_PNT);                                                       // Processing mesh...
  y_nodes         = spacetime->node.size ();                                                        // Getting number of nodes along "y" side...
  y_cells         = y_nodes - 1;                                                                    // Computing number of cells along "y" side...

  // MESH:
  spacetime->process (surface, N, NU_MSH_QUA_4);                                                    // Processing mesh...
  ...
  dA              = (float)pow (ds, N);                                                             // Computing cell area...
  dm              = rho*dA;                                                                         // Computing node mass...
  ...
  boundary.push_back (perimeter);                                                                   // Setting boundary surface...

  for(i = 0; i < boundary.size (); i++)
  {
    spacetime->process (boundary[i], N - 1, NU_MSH_PNT);                                            // Processing mesh...
  ...
  std::cout << std::endl;                                                                           // Printing message...
  std::cout << "Lattice x-cells:                            x_cells    = " << x_cells << " []";     // Printing message...
  std::cout << std::endl;                                                                           // Printing message...
  std::cout << "Lattice y-cells:                            y_cells    = " << y_cells << " []";     // Printing message...
  std::cout << std::endl;                                                                           // Printing message...
  std::cout << "Cell size:                                  ds         = " << ds << " [m]";         // Printing message...
  std::cout << std::endl;                                                                           // Printing message...
  std::cout << "Cell area:                                  dA         = " << dA << " [m^N]";       // Printing message...
  std::cout << std::endl;                                                                           // Printing message...
